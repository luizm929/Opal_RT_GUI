...
class Ui_RelayGUI(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(130, 20, 231, 151))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(130, 20, 261, 151))
        ...
        self.layoutWidget_2.setGeometry(QtCore.QRect(130, 20, 261, 151))
        ...
        QtCore.QTimer.singleShot(1000, lambda: self.updateLabel(self.mag_Ia, self.mag_Ib, self.mag_Ic, self.deg_Ia,
                                                                self.deg_Ib, self.deg_Ic,
                                                                self.mag_Va, self.mag_Vb, self.mag_Vc, self.deg_Va,
                                                                self.deg_Vb, self.deg_Vc,
                                                                self.mag_Pa, self.mag_Pb, self.mag_Pc, self.deg_Pa,
                                                                self.deg_Pb, self.deg_Pc))
        # ---------------------------------------------------------------------------------------------------------------

    # -------------------------------------------PART 3 to Update QLabels ( V,I etc readings)-------------------------------------------
